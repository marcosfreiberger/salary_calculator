...
export default class App extends Component {
   ...
   render() {
      ...
      return ( <
         ...
         div className = "row" >
         <
         InputReadWrite label = "Salário Bruto"
         value = {
            gross
         }
         onChange = {
         ...
         /> <
         InputReadOnly label = "Desconto INSS"
         value = {
            salary.inss_discount
         }
         percentage = {
            salary.inss_percentage
         }
         color = {
            inss_color
         }
         ...
         /> <
         InputReadOnly label = "Desconto IRPF"
         value = {
            salary.irpf_discount
         }
         percentage = {
            salary.irpf_percentage
         }
         color = {
            irpf_color
         }
         ...
         div className = "row" >
         <
         InputReadOnly label = "Salário Líquido"
         value = {
            salary.net_value
         }
         percentage = {
            salary.net_percentage
         }
         color = {
            net_color
         }
